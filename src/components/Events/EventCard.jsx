  ...
  return (
    <div className="flex justify-center bg-[black] items-center ">
      <div className=" relative">
        <img src={card} className="relative h-[450px] w-[300px]" alt="card" />
        <div className="absolute top-[30px] left-[45px] ">
          <img
            src={image}
        ...
        <div className="absolute top-[270px] left-[0px] flex flex-col gap-[20px] ">
          <div className="flex flex-col gap-[20px] ml-[70px]">
            <div className="text-[20px] text-[white] font-bold text-[white]  ">
              {name}
            </div>
            <div className="text-[15px] text-[white] text-center  ml-[-160px] ">
              {time}
            </div>
          </div>
